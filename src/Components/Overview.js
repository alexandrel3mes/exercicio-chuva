...
function Overview() {
  ...
  return(
    <div className="overview">
      <p className="overview-title">Resumo</p>
      ...
      <span className={moreStyle}>erisque enim ligula venenatis dolor. <br />
      Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce luctus vestibulum augue ut aliquet. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim ac. <br />
      In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum. Sed dapibus pulvinar nibh tempor porta.</span><span className="see-more" onClick={ () => seeMore() }>{moreOrLess}</span>
      </p>
    </div>
  )
}
